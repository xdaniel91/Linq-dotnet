    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int pag = 1; pag <= qtdPaginas; pag++)
            {
                ...
                ImprimirPagina(tamanhoPagina, qtdPaginas, context, skiper);
            }

            Console.ReadLine();
        }

        private static void ImprimirPagina(int tamanhoPagina, int quantitdadePaginas, DatabaseEntities context, int skip)
        {
